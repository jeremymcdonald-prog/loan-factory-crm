...
| Q8 | Market-rate data source for the P3 rate-aware refi radar (vendor, cost, licensing of displayed rates) — a **future read-only data connection** feeding Ally's outreach triggers and talking points; the CRM never becomes a pricing engine ([[Decisions]] D-22). | [[PRD]] FR-IN-3 P3 scope | Technical lead | Open |
